...
export const MESSAGES = {
  ...
  // a seat's checklist ends in.
  'training.title': 'TRAINING',
  'training.announce': 'TRAINING',
  'training.free': 'FREE PLAY',
  'training.count': '{done}/{total}',
  // the checklist steps, in order
  'training.step.move': 'MOVE',
  'training.step.jump': 'JUMP',
  'training.step.hover': 'HOVER',
  'training.step.light': 'LIGHT ATTACK',
  'training.step.heavy': 'HEAVY ATTACK',
  'training.step.block': 'BLOCK',
  'training.step.dash': 'DASH',
  'training.step.ranged': 'RANGED',
  'training.step.special': 'SPECIAL',
  'training.step.ult': 'ULTIMATE',
  'training.step.taunt': 'TAUNT',
  // ...and the button each step is on, PER DEVICE (game/input.js is the
  // source of truth; these are its bindings spelled out for the seat)
  'training.btn.pad.move': 'LEFT STICK',
  'training.btn.pad.jump': 'A',
  ...
  'training.btn.pad.taunt': 'D-PAD ▼',
  'training.btn.kb1.move': 'W A S D',
  'training.btn.kb1.jump': 'SPACE',
  'training.btn.kb1.hover': 'SPACE IN MID-AIR, HOLD',
  'training.btn.kb1.light': 'F',
  'training.btn.kb1.heavy': 'G',
  'training.btn.kb1.block': 'HOLD H',
  'training.btn.kb1.dash': 'HOLD SHIFT + MOVE',
  'training.btn.kb1.ranged': 'R',
  'training.btn.kb1.special': 'T',
  'training.btn.kb1.ult': 'Y',
  'training.btn.kb1.taunt': 'B',
  'training.btn.kb2.move': 'ARROW KEYS',
  'training.btn.kb2.jump': 'NUMPAD 0',
  'training.btn.kb2.hover': 'NUMPAD 0 IN MID-AIR, HOLD',
  'training.btn.kb2.light': 'NUMPAD 1',
  'training.btn.kb2.heavy': 'NUMPAD 2',
  'training.btn.kb2.block': 'HOLD NUMPAD 3',
  'training.btn.kb2.dash': 'HOLD NUMPAD ENTER + MOVE',
  'training.btn.kb2.ranged': 'NUMPAD 4',
  'training.btn.kb2.special': 'NUMPAD 5',
  'training.btn.kb2.ult': 'NUMPAD 6',
  'training.btn.kb2.taunt': 'NUMPAD .',
  'training.btn.touch.move': 'STICK',
  'training.btn.touch.jump': 'JMP',
  'training.btn.touch.hover': 'JMP IN MID-AIR, HOLD',
  'training.btn.touch.light': 'LT',
  'training.btn.touch.heavy': 'HV',
  'training.btn.touch.block': 'HOLD BLK',
  'training.btn.touch.dash': 'HOLD DSH + STICK',
  'training.btn.touch.ranged': 'RNG',
  'training.btn.touch.special': 'SP',
  'training.btn.touch.ult': 'ULT',
  'training.btn.touch.taunt': 'TAUNT',

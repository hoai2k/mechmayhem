...
// THE EDGE WRAP has to be SET UP, not climbed to. The engine runs live here
...
// descending the far face head-first is the wrap made visible
await shoot('wrap', 'f.climb && f.climb.phase === "wall" && f.climb.fwd.y < -0.3', 60000);
